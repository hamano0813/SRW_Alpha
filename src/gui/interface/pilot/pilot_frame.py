...
class PilotFrame(SmoothScrollArea):
    ...
    def _build_pilot_table(self, fields) -> FixedTableView:
        ...
        self._cqb_delegate = NumberSpinDelegate(value_range=(1, 255), show_buttons=False, parent=view)
        view.setItemDelegateForColumn(1, self._cqb_delegate)
        self._rng_delegate = NumberSpinDelegate(value_range=(1, 255), show_buttons=False, parent=view)
        view.setItemDelegateForColumn(2, self._rng_delegate)
        self._evd_delegate = NumberSpinDelegate(value_range=(1, 255), show_buttons=False, parent=view)
        view.setItemDelegateForColumn(3, self._evd_delegate)
        self._hit_delegate = NumberSpinDelegate(value_range=(1, 255), show_buttons=False, parent=view)
        view.setItemDelegateForColumn(4, self._hit_delegate)
        self._rxn_delegate = NumberSpinDelegate(value_range=(1, 255), show_buttons=False, parent=view)
        view.setItemDelegateForColumn(5, self._rxn_delegate)
        self._skl_delegate = NumberSpinDelegate(value_range=(1, 255), show_buttons=False, parent=view)
